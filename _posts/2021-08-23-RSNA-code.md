...
def animation_transform(idx, seq):
...
# List of csv file
CSV_DF = pd.read_csv(f'{ROOT_PATH}/train_labels.csv') # original DF
IDX_LIST_CSV = CSV_DF['BraTS21ID'].tolist()
strIDX_LIST_CSV = [str(str_idx).zfill(5) for str_idx in IDX_LIST_CSV]

# List from directory
IDX_LIST_DIR = os.listdir(f'{ROOT_PATH}/train/') # ['00000', '00002',...
...
#         print(elem, end=', ')
#     print(".")
T_DF = pd.DataFrame(tmp_df)

T_DF.to_csv('TMP_DF.csv', mode='w')
